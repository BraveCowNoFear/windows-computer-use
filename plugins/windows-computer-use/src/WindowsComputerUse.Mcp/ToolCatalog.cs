...
public static class ToolCatalog
{
    ...
    [
        ...
        Tool("scroll", "Scroll vertically or horizontally at a window, direct-screen, or desktop-screenshot point using SendInput; screenshot-bound scrolls return an inline before/after visual-diff summary.",
        ...
        Tool("drag", "Perform a self-contained drag with a selected mouse button between window, direct-screen, or desktop-screenshot points; screenshot-bound drags return an inline before/after visual-diff summary.",
