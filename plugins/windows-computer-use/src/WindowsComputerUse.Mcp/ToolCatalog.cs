...
public static class ToolCatalog
{
    ...
    [
        ...
        Tool("copy_text", "Atomically focus one semantic control, optionally select all, copy through real Ctrl+C, return Unicode text, and restore every prior clipboard format; tracked held keys must be released first.",
